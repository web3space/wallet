        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Invoice
            small.pug Clean invoice template.
      .pug.content
        .pug.row
          .pug.col-lg-12
            .pug.hpanel
                  ...
                  .pug.col-md-6
                    .pug.text-right
                      ...
                      button.pug.btn.btn-default.btn-sm
                        i.pug.fa.fa-check
                        span.pug  Save
                      button.pug.btn.btn-primary.btn-sm
                        i.pug.fa.fa-dollar
                        span.pug  Make A Payment
              .pug.panel-body.p-xl
                .pug.row.m-b-xl
                  .pug.col-sm-6
                    h4.pug IN-9177283-2016
                    address.pug
                      strong.pug Homer, Inc.
                      br.pug
                      span.pug                                 30 Mortensen Avenue
                      br.pug
                      span.pug                                 Salinas, CA 93905
                      br.pug
                      abbr.pug(title='Phone') P:
                      span.pug  (831) 758-7200
                  .pug.col-sm-6.text-right
                    span.pug To:
                    address.pug
                      strong.pug Corporate, Inc.
                      br.pug
                      span.pug                                 60 Mortensen Avenue
                      br.pug
                      span.pug                                 Salinas, CA 123343
                      br.pug
                      abbr.pug(title='Phone') P:
                      span.pug  (831) 752-7000
                    p.pug
                      span.pug
                        strong.pug Invoice Date:
                        span.pug  May 16, 2016
                      br.pug
                      span.pug
                        strong.pug Due Date:
                        span.pug  May 24, 2016
                .pug.table-responsive.m-t
                  table.pug.table.table-striped
                    ...
                    tbody.pug
                      tr.pug
                        td.pug
                          div.pug
                            strong.pug Lorem Ipsum is that it has a more-or-less normal
                          small.pug
                            span.pug Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            span.pug tempor incididunt ut labore.
                        td.pug 1
                        td.pug $26.00
                        td.pug $5.98
                        td.pug $31,98
                      tr.pug
                        td.pug
                          div.pug
                            strong.pug Lorem Ipsum is that it has
                          small.pug
                            span.pug Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            span.pug tempor incididunt ut labore et dolore magna aliqua.
                            span.pug Eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        td.pug 2
                        td.pug $80.00
                        td.pug $36.80
                        td.pug $196.80
                      tr.pug
                        td.pug
                          div.pug
                            strong.pug Has a more-or-less normal
                          small.pug
                            span.pug Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            span.pug tempor incididunt ut labore et dolore magna aliqua.
                        td.pug 3
                      ...
                      tr.pug
                        td.pug
                          div.pug
                            strong.pug That it has a more-or-less
                          small.pug
                            span.pug Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            span.pug tempor incididunt ut labore et dolore magna aliqua.
                        td.pug 4
                        ...
                        td.pug $193.10
                .pug.row.m-t
                  .pug.col-md-4.col-md-offset-8
                    table.pug.table.table-striped.text-right
                      tbody.pug
                        tr.pug
                          td.pug
                            strong.pug Sub Total :
                          td.pug $1026.00
                        tr.pug
                          td.pug
                            strong.pug TAX :
                ...
                .pug.row
                  .pug.col-md-6
                    .pug.m-t
                      strong.pug Comments
                      span.pug                                 It is a long established fact that a reader will be distracted by the readable content of a page
                      span.pug                                 when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less
