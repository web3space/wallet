        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Draggable panels
            small.pug Example page for draggable panels
      .pug.content
        .pug.row
          .pug.col-lg-4
            .pug.hpanel
              ...
              .pug.panel-body
                .pug.m-t-md.m-b-md.text-center
                  i.pug.fa.fa-hand-o-up.fa-4x
                  .pug.m-t Drag and move panels.
            .pug.hpanel
              .pug.panel-heading.hbuilt
                .pug.panel-tools
                  a.pug.showhide
              ...
              .pug.panel-body
                p.pug
                  span.pug Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
            .pug.hpanel
              .pug.panel-heading.hbuilt
                .pug.panel-tools
                  a.pug.showhide
