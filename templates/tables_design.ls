            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug Tables
                li.pug.active
                  span.pug Tables design
            h2.pug.font-light.m-b-xs
              span.pug Tables design
            small.pug Examples of various designs of tables.
      .pug.content
        .pug.row
          .pug.col-lg-8
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 This is a basic table design
              .pug.panel-body
                .pug.table-responsive
                  table.pug.table(cellpadding='1' cellspacing='1')
                    thead.pug
                      tr.pug
                        th.pug Name
                        th.pug Phone
                        th.pug Street Address
                        th.pug City
                        th.pug Country
                    tbody.pug
                      tr.pug
                        td.pug Abraham
                        td.pug 076 9477 4896
                        td.pug 294-318 Duis Ave
                        td.pug Vosselaar
                        td.pug Belgium
                      tr.pug
                        td.pug Phelan
                        td.pug 0500 034548
                        td.pug 680-1097 Mi Rd.
                        td.pug Lavoir
                        td.pug Pakistan
                      tr.pug
                        td.pug Raya
                        td.pug (01315) 27698
                        td.pug Ap #289-8161 In Avenue
                        td.pug Santomenna
                        td.pug Burkina Faso
                      tr.pug
                        td.pug Azalia
                        td.pug 0500 854198
                        td.pug 226-4861 Augue. St.
                        td.pug Newtown
                        td.pug Christmas Island
                      tr.pug
                        td.pug Garth
                        td.pug (01662) 59083
                        td.pug 3219 Elit Avenue
                        td.pug Ternitz
                        td.pug Saint Martin
                      tr.pug
                        td.pug Selma
                        td.pug 0877 118 6905
                        td.pug P.O. Box 410, 7331 Nec, St.
                        td.pug Glenrothes
                        td.pug Korea, North
              .pug.panel-footer
                span.pug Table - 6 rows
          .pug.col-lg-4
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 This is a condensed basic table
              .pug.panel-body
                .pug.table-responsive
                  table.pug.table.table-condensed(cellpadding='1' cellspacing='1')
                    thead.pug
                      tr.pug
                        th.pug Name
                        th.pug Phone
                    ...
                    tbody.pug
                      tr.pug
                        td.pug Henry
                        td.pug Purus Gravida Sagittis Limited
                        td.pug 055 1753 4032
                      tr.pug
                        td.pug Shelly
                        td.pug Posuere Enim Inc.
                        td.pug 0313 143 2317
                      tr.pug
                        td.pug Edan
                        td.pug Quisque Imperdiet Company
                        td.pug 076 1743 8649
                      tr.pug
                        td.pug Sophia
                        td.pug Quam Incorporated
                        td.pug 0863 826 7513
                      tr.pug
                        td.pug Griffith
                        td.pug Tempor Erat Corp.
                        td.pug 0845 46 45
              .pug.panel-footer
                span.pug Table - 5 rows
        .pug.row
          .pug.col-lg-4
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 This is a striped table design
              .pug.panel-body
                .pug.table-responsive
                  table.pug.table.table-condensed.table-striped(cellpadding='1' cellspacing='1')
                    thead.pug
                      tr.pug
                        th.pug Name
                        th.pug Phone
            ...
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 This is a bordered striped basic table
              .pug.panel-body
                .pug.table-responsive
                  table.pug.table.table-bordered.table-striped(cellpadding='1' cellspacing='1')
                    thead.pug
                      tr.pug
                        th.pug Name
                        th.pug Phone
            ...
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 This is a bordered striped and responsive table
              .pug.panel-body
                .pug.table-responsive
                  table.pug.table.table-bordered.table-striped(cellpadding='1' cellspacing='1')
                    thead.pug
