        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug ChartJS
            small.pug Simple HTML5 Charts using the canvas element
      .pug.content
        .pug.row
          .pug.col-lg-4
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Radar type chart
              .pug.panel-body
                div.pug
                  canvas.pug#radarChart(height='200')
          .pug.col-lg-4
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Doughnut bar chart
              .pug.panel-body
                div.pug
                  canvas.pug#doughnutChart(height='200')
          .pug.col-lg-4
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Polar type chart
              .pug.panel-body
                div.pug
                  canvas.pug#polarOptions(height='200')
        .pug.row
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Line type chart
              .pug.panel-body
                div.pug
                  canvas.pug#lineOptions(height='140')
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Bar type chart
              .pug.panel-body
                div.pug
                  canvas.pug#barOptions(height='140')
        .pug.row
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Single Bar type chart
              .pug.panel-body
                div.pug
                  canvas.pug#singleBarOptions(height='140')
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Line type chart without curve
              .pug.panel-body
                div.pug
                  canvas.pug#sharpLineOptions(height='140')
