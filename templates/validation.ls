        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Validation
            small.pug Build a form with validation functionality
      .pug.content
        .pug.row
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                     jQuery Validation Plugin
              .pug.panel-body
                p.pug
                  span.pug The jQuery Validation Plugin provides drop-in validation for your existing forms, while making all kinds of customizations to fit your application really easy.
                form.pug#form(role='form')
                  .pug.form-group
                    label.pug Email
                    input.pug.form-control(type='email' placeholder='Enter email' required='')
                  .pug.form-group
                    label.pug Password
                    input.pug.form-control(type='password' placeholder='Password' name='password')
                  .pug.form-group
                    label.pug Url
                    input.pug.form-control(type='text' placeholder='Enter email' name='url')
                  .pug.form-group
                    label.pug Number
                    input.pug.form-control(type='text' placeholder='Enter email' name='number')
                  .pug.form-group
                    label.pug MaxLength
                    input.pug.form-control(type='text' placeholder='Enter email' name='max')
                  div.pug
                    button.pug.btn.btn-sm.btn-primary.m-t-n-xs(type='submit')
                      strong.pug Submit
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                     Displaying Errors within Field Labels
              .pug.panel-body
                p.pug
                  span.pug With errorPlacement() function you can easily change placement for error. With message properties you can set your own text for error message.
                form.pug#form_2(role='form')
                  .pug.form-group
                    label.pug(for='name') First name
                    input.pug#name.form-control(type='text' name='name' placeholder='Enter your name' required='')
                  .pug.form-group
                    label.pug(for='last_name') Last name
                    input.pug#last_name.form-control(type='text' placeholder='Enter your last name' name='last_name')
                  .pug.form-group
                    label.pug(for='url') Official website
                    input.pug#url.form-control(type='text' placeholder='www.example.com' name='url')
                  .pug.form-group
                    label.pug(for='number') Phone number
                    input.pug#number.form-control(type='text' placeholder='Phone number' name='number')
                  .pug.form-group
                    label.pug(for='username') Username
                    input.pug#username.form-control(type='text' placeholder='Login' name='username')
                  div.pug
                    button.pug.btn.btn-sm.btn-primary.m-t-n-xs(type='submit')
                      strong.pug Submit
          .pug.col-lg-12
              ...
              .pug.panel-body.no-padding
                table.pug.table.table-striped
                  ...
                  tbody.pug
                    tr.pug
                      td.pug remote
                      td.pug Requests a resource to check the element for validity.
                    tr.pug
                      td.pug minlength
                      td.pug Makes the element require a given minimum length.
                    tr.pug
                      td.pug    maxlength
                      td.pug Makes the element require a given maxmimum length.
                    tr.pug
                      td.pug  rangelength
                      td.pug  Makes the element require a given value range.
                    tr.pug
                      td.pug   min
                      td.pug   Makes the element require a given minimum.
                    tr.pug
                      td.pug    max
                      td.pug  Makes the element require a given maximum.
                    tr.pug
                      td.pug  range
                      td.pug  Makes the element require a given value range.
                    tr.pug
                      td.pug  email
                      td.pug  Makes the element require a valid email
                    tr.pug
                      td.pug   url
                      td.pug   Makes the element require a valid url
                    tr.pug
                      td.pug    date
                      td.pug  Makes the element require a date.
                    tr.pug
                      td.pug  dateISO
                      td.pug  Makes the element require an ISO date.
                    tr.pug
                      td.pug  number
                      td.pug  Makes the element require a decimal number.
                    tr.pug
                      td.pug  digits
                      td.pug   Makes the element require digits only.
                    tr.pug
                      td.pug  creditcard
                      td.pug  Makes the element require a credit card number.
                    tr.pug
                      td.pug  equalTo
                      td.pug  Requires the element to be the same as another one
