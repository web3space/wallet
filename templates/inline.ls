            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug Charts
                li.pug.active
                  span.pug Inline charts 
            h2.pug.font-light.m-b-xs
              span.pug Inline charts
            small.pug Small inline charts directly in the browser using data supplied in scripts.
      .pug.content
        .pug.row
          .pug.col-lg-12
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Sparkline charts
              .pug.panel-body
                p.pug
                  span.pug This jQuery plugin generates sparklines (small inline charts) directly in the browser using data supplied either inline in the HTML
                table.pug.table.table-bordered.white-bg
                  thead.pug
                    tr.pug
                      th.pug Graph
                      th.pug Type
                  tbody.pug
                    ...
                    tr.pug
                      td.pug
                        span.pug#sparkline4
                      td.pug
                        span.pug Long inline chart
                    tr.pug
                      td.pug
                        span.pug#sparkline5
                      td.pug
                        span.pug Tristate chart
                    tr.pug
                      td.pug
                        span.pug#sparkline6
                      td.pug
                        span.pug Discrete chart
        .pug.row
          .pug.col-lg-12
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Peity charts
              .pug.panel-body
                p.pug
                  span.pug Peity is a simple jQuery plugin that converts an element&apos;s content into a simple svg mini pie donut line or bar chart and is compatible with any browser that supports svg: Chrome, Firefox, IE9+, Opera, Safari.
                table.pug.table.table-bordered.white-bg
                  thead.pug
                    tr.pug
                      th.pug Graph
                  ...
                  tbody.pug
                    ...
                    tr.pug
                      td.pug
                        span.pug.line 5,3,9,6,5,9,7,3,5,2
                      td.pug
                        span.pug Line chart
                    tr.pug
                      td.pug
                        span.pug.bar 5,3,9,6,5,9,7,3,5,2
                      td.pug
                        span.pug Bar chart
