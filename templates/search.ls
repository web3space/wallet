            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug App views
                li.pug.active
                  span.pug Search view
            h2.pug.font-light.m-b-xs
              span.pug Search view
            small.pug Use search view to show search functionality.
      .pug.content
        .pug.row
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.m-b-md
                  h4.pug
                    span.pug Filters
                  small.pug
                    span.pug Filter your project basend on diferent options below.
                .pug.form-group
                  label.pug.control-label Project date:
                  .pug.input-group.date
                    input.pug.form-control(type='text' value='10/06/2016')
                    span.pug.input-group-addon
                      i.pug.glyphicon.glyphicon-calendar
                .pug.form-group
                  label.pug.control-label Project value:
                  .pug.input-group
                    input.pug#demo1(type='text' name='demo1' value='50')
                .pug.form-group
                  label.pug.control-label Client:
                  .pug.input-group
                    select.pug.form-control.m-b(name='account')
                      option.pug(selected='') Company and Brothers
                      option.pug Morgan &amp; Morgan Inc.
                .pug.form-group
                  label.pug.control-label Employees
                  .pug.input-group
                    input.pug#demo2(type='text' name='demo2' value='2')
                .pug.form-group
                  label.pug.control-label Status:
                  .pug.input-group
                    .pug.checkbox.checkbox-primary
                      input.pug#checkbox1(checked='' type='checkbox')
                      label.pug(for='checkbox1')
                        span.pug Completed
                    .pug.checkbox.checkbox-success
                      input.pug#checkbox2(type='checkbox')
                    ...
                    .pug.checkbox.checkbox-success
                      ...
                      label.pug(for='checkbox3')
                        span.pug Cancel
                .pug.form-group
                  label.pug.control-label Tags:
                  .pug.input-group
                    select.pug.select2(multiple='multiple')
                      option.pug(selected='' value='Branding') Branding
                      option.pug(selected='' value='Website') Website
                      option.pug(selected='' value='Design') Design
                      option.pug(selected='' value='Ilustration') Ilustration
                      option.pug(selected='' value='New') New
                      option.pug(value='Important') Important
                      option.pug(value='External') External
                button.pug.btn.btn-success.btn-block Apply
          .pug.col-md-9
            .pug.row
              .pug.col-lg-12
                .pug.hpanel
                  .pug.panel-body
                    .pug.input-group
                      input.pug.form-control(type='text' placeholder='Search projects..')
                      .pug.input-group-btn
                        button.pug.btn.btn-default
                          i.pug.fa.fa-search
            .pug.row
              .pug.col-lg-12
                .pug.hpanel.filter-item
                  a.pug(href='#')
                    .pug.panel-body
                      ...
                      h4.pug.m-b-xs Desing project
                      p.pug.small
                        span.pug Lorem Ipsum as their default model text, and a search for &apos;lorem ipsum&apos; will uncover many web sites still
                .pug.hpanel.filter-item.active
                  a.pug(href='#')
                    .pug.panel-body
                      .pug.pull-right.text-right
                        small.pug.stat-label Last week
                        h4.pug
                          span.pug $140,70 
                          i.pug.fa.fa-long-arrow-right.text-info
                      h4.pug.m-b-xs Project manager app
                      p.pug.small It is a long established fact that a reader will be distracted by the readable
                .pug.hpanel.filter-item
                  a.pug(href='#')
                    .pug.panel-body
                      .pug.pull-right.text-right
                        ...
                        h4.pug
                          span.pug $580,90 
                          i.pug.fa.fa-level-down.text-danger
                      h4.pug.m-b-xs New branding
                      p.pug.small There are many variations of passages of Lorem Ipsum available, 
                .pug.hpanel.filter-item
                  a.pug(href='#')
                    .pug.panel-body
                      .pug.pull-right.text-right
                        ...
                        h4.pug
                          span.pug $170,20 
                          i.pug.fa.fa-level-up.text-warning
                      h4.pug.m-b-xs Website project
                      p.pug.small All the Lorem Ipsum generators on the Internet tend to repeat
                .pug.hpanel.filter-item
                  a.pug(href='#')
                    .pug.panel-body
                      .pug.pull-right.text-right
                        ...
                        h4.pug
                          span.pug $240,70 
                          i.pug.fa.fa-level-up.text-success
                      h4.pug.m-b-xs Ilustration project
                      p.pug.small
                        span.pug Making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words
                .pug.hpanel.filter-item
                  a.pug(href='#')
                    .pug.panel-body
                      .pug.pull-right.text-right
