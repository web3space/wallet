            ...
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Animation panel
              .pug.panel-body
                p.pug
                  strong.pug Homer
                  span.pug  has special small function 
                  code.pug animate-panel
                  span.pug  that allowes you to implement staggering animations to any layout elements.
                  span.pug                     It is designed to work on any html elements in order to achive a effect of building layout on page load.
                  span.pug                     This function is mainly for main layout elements.
                p.pug
                  span.pug It is easy to use. All you have to do is to add new class 
                  code.pug .animate-panel
                  span.pug  to wrapper of elements that should be staggering. For example:
                pre.pug.
                ...
                p.pug
                  span.pug In default function get all 
                  code.pug .row &gt; div
                  span.pug  elements and applay 
                  strong.pug zoomIn
                  span.pug  effect. You can use any effect avalible with 
                  strong.pug Animatin.css
                  span.pug  library. You can find many example of use in Homer theme but feel free to play with examples below.
          .pug.col-lg-7
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Live preview
              .pug.panel-body
                p.pug Select one of the animation from Animation.css library
                select.pug.form-control.animation-select(name='animation')
                  optgroup.pug(label='Bouncing Entrances')
                    option.pug(value='bounceIn') bounceIn
                    option.pug(value='bounceInDown') bounceInDown
                    option.pug(value='bounceInLeft') bounceInLeft
                    option.pug(value='bounceInRight') bounceInRight
                    option.pug(value='bounceInUp') bounceInUp
                  optgroup.pug(label='Fading Entrances')
                    option.pug(value='fadeIn') fadeIn
                    option.pug(value='fadeInDown') fadeInDown
                    option.pug(value='fadeInDownBig') fadeInDownBig
                    option.pug(value='fadeInLeft') fadeInLeft
                    option.pug(value='fadeInLeftBig') fadeInLeftBig
                    option.pug(value='fadeInRight') fadeInRight
                    option.pug(value='fadeInRightBig') fadeInRightBig
                    option.pug(value='fadeInUp') fadeInUp
                    option.pug(value='fadeInUpBig') fadeInUpBig
                  optgroup.pug(label='Flippers')
                    option.pug(value='flipInX') flipInX
                    option.pug(value='flipInY') flipInY
                    option.pug(value='flipOutX') flipOutX
                    option.pug(value='flipOutY') flipOutY
                  optgroup.pug(label='Lightspeed')
                    option.pug(value='lightSpeedIn') lightSpeedIn
                  optgroup.pug(label='Rotating Entrances')
                    option.pug(value='rotateIn') rotateIn
                    option.pug(value='rotateInDownLeft') rotateInDownLeft
                    option.pug(value='rotateInDownRight') rotateInDownRight
                    option.pug(value='rotateInUpLeft') rotateInUpLeft
                    option.pug(value='rotateInUpRight') rotateInUpRight
                  optgroup.pug(label='Zoom Entrances')
                    option.pug(selected='' value='zoomIn') zoomIn
                    option.pug(value='zoomInDown') zoomInDown
                    option.pug(value='zoomInLeft') zoomInLeft
                    option.pug(value='zoomInRight') zoomInRight
                    option.pug(value='zoomInUp') zoomInUp
                button.pug.btn.btn-success.m-t-sm.runAnimation Play it!
            .pug#acontainer
              .pug.runIt
                .pug.row.animate-panel-demo.setEffect(data-effect='zoomIn' data-child='hpanel')
                  .pug.col-lg-4
                    .pug.hpanel
                      .pug.panel-heading
                        .pug.panel-tools
