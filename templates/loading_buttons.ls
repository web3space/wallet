            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug Interface
                li.pug.active
                  span.pug Loading buttons
            h2.pug.font-light.m-b-xs
              span.pug Ladda
            small.pug Loading buttons
      .pug.content
        .pug.row
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Basic buttons example
              .pug.panel-body
                strong.pug Ladda
                p.pug
                  span.pug A UI concept which merges loading indicators into the action that invoked them. Primarily intended for use with forms where it gives users immediate feedback upon submit rather than leaving them wondering while the browser does its thing.
                .pug.row
                  .pug.col-sm-3
                    h5.pug expand-left
                    button.pug.ladda-button.btn.btn-success(data-style='expand-left')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug expand-right
                    button.pug.ladda-button.btn.btn-success(data-style='expand-right')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug expand-up
                    button.pug.ladda-button.btn.btn-success(data-style='expand-up')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug expand-down
                    button.pug.ladda-button.btn.btn-success(data-style='expand-down')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                .pug.row.m-t-md
                  .pug.col-sm-3
                    h5.pug contract
                    button.pug.ladda-button.btn.btn-warning(data-style='contract')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug zoom-in
                    button.pug.ladda-button.btn.btn-warning(data-style='zoom-in')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug zoom-out
                    button.pug.ladda-button.btn.btn-warning(data-style='zoom-out')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                .pug.row.m-t-md
                  .pug.col-sm-3
                    h5.pug slide-left
                    button.pug.ladda-button.btn.btn-info(data-style='slide-left')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug slide-right
                    button.pug.ladda-button.btn.btn-info(data-style='slide-right')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug slide-up
                    button.pug.ladda-button.btn.btn-info(data-style='slide-up')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                  .pug.col-sm-3
                    h5.pug slide-down
                    button.pug.ladda-button.btn.btn-info(data-style='slide-down')
                      span.pug.ladda-label Submit
                      span.pug.ladda-spinner
                .pug.row.m-t-lg
                  .pug.col-sm-3
                    section.pug.progress-demo
                      h5.pug expand-right
                      button.pug.ladda-button.btn.btn-danger(data-style='expand-right')
                        span.pug.ladda-label Submit
                        span.pug.ladda-spinner
                  .pug.col-sm-3
                    section.pug.progress-demo
                      h5.pug contract
                      button.pug.ladda-button.btn.btn-danger(data-style='contract')
                        span.pug.ladda-label Submit
                        span.pug.ladda-spinner
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                API Example
              .pug.panel-body
                h5.pug.m-t-none.m-b-sm Demo how to use with api services
                button.pug.ladda-button.ladda-button-demo.btn.btn-primary.btn-block(data-style='zoom-in')
                  span.pug.ladda-label Submit
                  span.pug.ladda-spinner
                .pug.m-t-sm
                  pre.pug.
