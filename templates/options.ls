          ...
          .pug.hpanel
            .pug.panel-body
              ...
              h2.pug.font-light.m-b-xs
                span.pug Options
              small.pug Example small header for demo purpose.
        .pug.content
          .pug.row
            .pug.col-md-12
              .pug.hpanel
                .pug.panel-body
                  h1.pug Options
                  p.pug.lead
                    span.pug Homer admin theme gives you few configure options for your application layout. Each of the layout element: navigation, navbar, small header and footer can be fixed positioning.
                  p.pug
                    span.pug Use below buttons to enable/disable available options.
                  div.pug
                    dl.pug.dl-horizontal
                      dt.pug(style='text-align: left') Sidebar scroll
                      dd.pug.status-fixed-sidebar
                        span.pug.text-success.font-bold On
                      dt.pug(style='text-align: left') Fixed navbar
                      dd.pug.status-fixed-navbar
                        span.pug.text-success.font-bold On
                      dt.pug(style='text-align: left') Fixed footer
                      dd.pug.status-fixed-footer Off
                      dt.pug(style='text-align: left') Fixed small header
                      dd.pug.status-fixed-small-header Off
                      dt.pug(style='text-align: left') Boxed layout
                      dd.pug.status-boxed-layout Off
          .pug.row
            .pug.col-lg-6
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Fixed navbar
                .pug.panel-body
                  p.pug
                    span.pug Fixed navbar is a top navbar that is sticked on screen.
                  p.pug
                    span.pug To add fixed navbar you need to add .fixed-navbar class to body element.
                  .pug.text-center
                    button.pug#fixed-navbar.btn.btn-success(type='button')
                      span.pug Toggle fixed navbar
                  .pug.m-t-md
                    pre.pug.
                      \n
              ...
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Sidebar scroll
                .pug.panel-body
                  p.pug
                    span.pug Sidebar scroll is a (left menu) sidebar that is sticked on screen.
                  p.pug
                    span.pug To add sidebar scroll you need to add .sidebar-scroll class to body. Sidebar scroll works with fixed-navbar.
                  .pug.text-center
                    button.pug#fixed-sidebar.btn.btn-success(type='button')
                      span.pug Toggle sidebar scroll
                  .pug.m-t-md
                    pre.pug.
                      \n
              ...
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Fixed footer
                .pug.panel-body
                  p.pug
                    span.pug Fixed footer is a bottom footer that is sticked on screen.
                  p.pug
                    span.pug To add fixed footer you need to add .fixed-footer class to body element.
                  .pug.text-center
                    button.pug#fixed-footer.btn.btn-success(type='button')
                      span.pug Toggle footer footer
                  .pug.m-t-md
                    pre.pug.
                      \n
              ...
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Fixed small header
                .pug.panel-body
                  p.pug
                    span.pug Fixed small header is a top page header that is sticked on screen (only small version).
                  p.pug
                    span.pug To add fixed small header you need to add .fixed-small-header class to body. Fixed sidebar works with fixed-navbar and fiexd sidebar.
                  .pug.text-center
                    button.pug#fixed-small-header.btn.btn-success(type='button')
                      span.pug Toggle fixed small header
                  .pug.m-t-md
                    pre.pug.
                      \n
              ...
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Boxed layout
                .pug.panel-body
                  p.pug
                    span.pug Boxed layout is an option for fixed width and centered layout on desktop resolution.
                  p.pug
                    span.pug To add boxed layout you need to add .boxed class to body element and special additional div wrapper after body tag with .boxed-wrapper class.
                  .pug.text-center
                    button.pug#boxed-layout.btn.btn-success(type='button')
                      span.pug Toggle boxed layout
                  .pug.m-t-md
                    pre.pug.
                      \n<body class="boxed">
