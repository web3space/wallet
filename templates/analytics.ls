      ...
      .pug.content.animate-panel
          ...
          .pug.col-lg-3
            .pug.hpanel.stats
              .pug.panel-body.h-200
                ...
                .pug.m-t-xl
                  h3.pug.m-b-xs 4 210,160
                  span.pug.font-bold.no-margins
                    span.pug Social users
                  .pug.progress.m-t-xs.full.progress-small
                    .pug.progress-bar.progress-bar-success(style='width: 55%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='55' role='progressbar')
        ...
        .pug.row
            ...
            .pug.hpanel.stats
              .pug.panel-body.h-200
                .pug.stats-title.pull-left
                  h4.pug Page Views
                .pug.stats-icon.pull-right
                  i.pug.pe-7s-credit.fa-4x
                .pug.clearfix
                .pug.flot-chart
                  .pug#flot-bar-chart.flot-chart-content
                .pug.m-t-xs
                  .pug.row
                    .pug.col-xs-5
                      small.pug.stat-label Today
          ...
          .pug.col-lg-3
            .pug.hpanel
              .pug.panel-body.text-center.h-200
                i.pug.pe-7s-graph2.fa-4x
                h1.pug.m-xs $802,40
                small.pug
                  span.pug Lorem ipsum dolor sit amet, consectetur adipiscing elit vestibulum consectetur adipiscing elit.
              .pug.panel-footer
                span.pug This is standard panel footer
          .pug.col-lg-3
            .pug.hpanel.stats
              .pug.panel-body.h-200
                ...
                .pug.clearfix
                .pug.flot-chart
                  .pug#flot-pie-chart.flot-chart-content(style='height: 112px')
              .pug.panel-footer
                span.pug This is standard panel footer
        .pug.row
          .pug.col-lg-3
            ...
            .pug.hpanel.stats
              .pug.panel-body.h-200
                .pug.stats-title.pull-left
                  h4.pug Today income
                .pug.stats-icon.pull-right
                  i.pug.pe-7s-gleam.fa-4x
                .pug.clearfix
                .pug.flot-chart
                  .pug#flot-line-chart.flot-chart-content(style='height: 125px')
              .pug.panel-footer
                span.pug This is standard panel footer
          .pug.col-lg-3
            .pug.hpanel.stats
              .pug.panel-body.h-200.list
                .pug.stats-title.pull-left
                  h4.pug Users Activity
                .pug.stats-icon.pull-right
                  i.pug.pe-7s-display1.fa-4x
                .pug.m-t-xl
                  small.pug
                    span.pug Lorem Ipsum is simply dummy text of the printing..
                .pug.progress.m-t-xs.full.progress-small
                  .pug.progress-bar.progress-bar-success(style='width: 25%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='25' role='progressbar')
                    span.pug.sr-only 35% Complete (success)
                .pug.progress.m-t-xs.full.progress-small
                  .pug.progress-bar.progress-bar-success(style='width: 35%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='35' role='progressbar')
                    span.pug.sr-only 35% Complete (success)
                .pug.progress.m-t-xs.full.progress-small
                  .pug.progress-bar.progress-bar-success(style='width: 55%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='55' role='progressbar')
                    span.pug.sr-only 35% Complete (success)
                .pug.progress.m-t-xs.full.progress-small
                  .pug.progress-bar.progress-bar-success(style='width: 95%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='95' role='progressbar')
                    span.pug.sr-only 35% Complete (success)
              .pug.panel-footer
                span.pug This is standard panel footer
          .pug.col-lg-3
