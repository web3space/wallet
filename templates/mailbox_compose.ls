          ...
          .pug.col-md-9
            .pug.hpanel.email-compose
              .pug.panel-heading.hbuilt
                .pug.p-xs.h4
                  span.pug New message
              .pug.panel-heading.hbuilt
                .pug.p-xs
                  form.pug.form-horizontal(method='get')
                    .pug.form-group
                      label.pug.col-sm-1.control-label.text-left To:
                      .pug.col-sm-11
                        input.pug.form-control.input-sm(type='text' placeholder='example@email.com')
                    .pug.form-group
                      label.pug.col-sm-1.control-label.text-left Cc:
                      .pug.col-sm-11
                        input.pug.form-control.input-sm(type='text')
                    .pug.form-group
                      label.pug.col-sm-1.control-label.text-left Subject:
                      .pug.col-sm-11
                        input.pug.form-control.input-sm(type='text' placeholder='Enter Email subject')
              .pug.panel-body.no-padding
                .pug.summernote
                  h5.pug Hello Jonathan! 
                  p.pug
                ...
                .pug.pull-right
                  .pug.btn-group
                    ...
                    button.pug.btn.btn-default
                      i.pug.fa.fa-trash
                      span.pug  Discard
                button.pug.btn.btn-primary Send email
                .pug.btn-group
                  button.pug.btn.btn-default
