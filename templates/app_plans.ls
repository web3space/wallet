        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug App plans
            small.pug Present pricing option for your app
      .pug.content
        .pug.row
          .pug.col-lg-12
            .pug.text-center.m-b-xl
              h3.pug Best pricing for your app
              p.pug
                span.pug Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &apos;lorem ipsum&apos; and web page editors now use Lorem Ipsum as their default model text, will uncover many web sites still in their infancy.
            .pug.row
              .pug.col-sm-3
                .pug.hpanel.plan-box.hyellow
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Basic plan
                  .pug.panel-body
                    p.pug.text-muted
                    ...
                    table.pug.table
                      ...
                      tbody.pug
                        ...
                        tr.pug
                          td.pug
                            i.pug.fa.fa-square-o
                            span.pug  AngularJS version
                        tr.pug
                          td.pug
                            i.pug.fa.fa-square-o
                            span.pug  Meteor version
                        tr.pug
                          td.pug
                            i.pug.fa.fa-square-o
                            span.pug  Support
                    ...
                    h3.pug.font-bold
                      span.pug $10/month
                    a.pug.btn.btn-warning.btn-sm.m-t-xs(href='#') Select plan
              .pug.col-sm-3
                .pug.hpanel.plan-box.hgreen.active
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Standard plan
                  .pug.panel-body
                    p.pug.text-muted
                      span.pug Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.
                    table.pug.table
                    ...
                    h3.pug.font-bold
                      span.pug $20/month
                    a.pug.btn.btn-success.btn-sm.m-t-xs(href='#') Select plan
              .pug.col-sm-3
                .pug.hpanel.plan-box.hblue
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Premium plan
                  .pug.panel-body
                    p.pug.text-muted
                      span.pug Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.
                    table.pug.table
                    ...
                    h3.pug.font-bold
                      span.pug $30/month
                    a.pug.btn.btn-info.btn-sm.m-t-xs(href='#') Select plan
              .pug.col-sm-3
                .pug.hpanel.plan-box.hred
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Prestige plan
                  .pug.panel-body
                    p.pug.text-muted
                      span.pug Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.
                    table.pug.table
                    ...
                    h3.pug.font-bold
                      span.pug $40/month
                    a.pug.btn.btn-danger.btn-sm.m-t-xs(href='#') Select plan
            hr.pug.m-b-xl
            .pug.row
              .pug.col-sm-3
                .pug.hpanel.plan-box
                  ...
                  .pug.panel-body.text-center
                    i.pug.pe.pe-7s-cup.big-icon.text-warning
                    h4.pug.font-bold
                      span.pug $10/month
                    p.pug.text-muted
                      span.pug There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable.
                    a.pug.btn.btn-warning.btn-sm(href='#') Select basic plan
              .pug.col-sm-3
                .pug.hpanel.plan-box.active
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Standard plan
                  .pug.panel-body.text-center
                    i.pug.pe.pe-7s-science.big-icon.text-success
                    h4.pug.font-bold
                      span.pug $20/month
                    p.pug.text-muted
                      span.pug There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable.
                    a.pug.btn.btn-success.btn-sm(href='#') Select standard plan
              .pug.col-sm-3
                .pug.hpanel.plan-box
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Premium plan
                  .pug.panel-body.text-center
                    i.pug.pe.pe-7s-refresh-cloud.big-icon.text-info
                    h4.pug.font-bold
                      span.pug $30/month
                    p.pug.text-muted
                      span.pug There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable.
                    a.pug.btn.btn-info.btn-sm(href='#') Select premium plan
              .pug.col-sm-3
                .pug.hpanel.plan-box
                  .pug.panel-heading.hbuilt.text-center
                    h4.pug.font-bold Prestige plan
                  .pug.panel-body.text-center
                    i.pug.pe.pe-7s-server.big-icon.text-danger
                    h4.pug.font-bold
                      span.pug $40/month
                    p.pug.text-muted
                      span.pug There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable.
                    a.pug.btn.btn-danger.btn-sm(href='#') Select prestige plan
