        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Contacts
            small.pug Show users list in nice and color panels
      .pug.content
        .pug.row
          .pug.col-lg-3
            .pug.hpanel.hgreen.contact-panel
              .pug.panel-body
                span.pug.label.label-success.pull-right NEW
                img.pug.img-circle.m-b(alt='logo' src='images/profile.jpg')
                h3.pug
                  a.pug(href='')  Bradly Danforth 
                ...
                .pug.row
                  ...
                  .pug.col-md-4
                    .pug.contact-stat
                      ...
                      strong.pug 400
          .pug.col-lg-3
            .pug.hpanel.hyellow.contact-panel
              .pug.panel-body
                img.pug.img-circle.m-b(alt='logo' src='images/a4.jpg')
                h3.pug
                  a.pug(href='')  Tangela Sternberg 
                .pug.text-muted.font-bold.m-b-xs California, LA
                p.pug
                  span.pug Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan.
              .pug.panel-footer.contact-footer
                .pug.row
                  ...
                  .pug.col-md-4
                    .pug.contact-stat
                      ...
                      strong.pug 400
          .pug.col-lg-3
            .pug.hpanel.hviolet.contact-panel
              .pug.panel-body
                img.pug.img-circle.m-b(alt='logo' src='images/a2.jpg')
                h3.pug
                  a.pug(href='')  Claud Vogan 
                .pug.text-muted.font-bold.m-b-xs California, LA
                p.pug
                  span.pug Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan.
              .pug.panel-footer.contact-footer
                .pug.row
                  ...
                  .pug.col-md-4
                    .pug.contact-stat
                      ...
                      strong.pug 400
          .pug.col-lg-3
            .pug.hpanel.hblue.contact-panel
              .pug.panel-body
                img.pug.img-circle.m-b(alt='logo' src='images/a3.jpg')
                h3.pug
                  a.pug(href='')  Valda Purdy 
                .pug.text-muted.font-bold.m-b-xs California, LA
                p.pug
                  span.pug Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan.
              .pug.panel-footer.contact-footer
        ...
        .pug.row
          .pug.col-lg-3
            .pug.hpanel.hblue.contact-panel
              .pug.panel-body
                img.pug.img-circle.m-b(alt='logo' src='images/a9.jpg')
                h3.pug
          ...
          .pug.col-lg-3
            .pug.hpanel.hgreen.contact-panel
              .pug.panel-body
                img.pug.img-circle.m-b(alt='logo' src='images/a5.jpg')
                h3.pug
                  a.pug(href='') Max Simson
                .pug.text-muted.font-bold.m-b-xs California, LA
                p.pug
          ...
          .pug.col-lg-3
            .pug.hpanel.hyellow.contact-panel
              .pug.panel-body
                span.pug.label.label-warning.pull-right SPECIAL
                img.pug.img-circle.m-b(alt='logo' src='images/a6.jpg')
                h3.pug
                  a.pug(href='') Max Simson
                .pug.text-muted.font-bold.m-b-xs California, LA
                p.pug
                ...
                .pug.row
                  ...
                  .pug.col-md-4
                    .pug.contact-stat
                      ...
                      strong.pug 400
          .pug.col-lg-3
            .pug.hpanel.hred.contact-panel
              .pug.panel-body
                img.pug.img-circle.m-b(alt='logo' src='images/a7.jpg')
                h3.pug
                  a.pug(href='') Max Simson
                .pug.text-muted.font-bold.m-b-xs California, LA
                p.pug
