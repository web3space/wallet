            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug Interface
                li.pug.active
                  span.pug Nestable list
            h2.pug.font-light.m-b-xs
              span.pug Nestable list
            small.pug Nestable - Drag &amp; drop hierarchical list.
      .pug.content
        .pug.row
          .pug.col-md-4
            .pug#nestable-menu
              button.pug.btn.btn-default.btn-sm(type='button' data-action='expand-all') Expand All
              button.pug.btn.btn-default.btn-sm(type='button' data-action='collapse-all') Collapse All
        .pug.row
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Nestable custom theme list
              .pug.panel-body
                p.pug.m-b-lg
                  span.pug Each list you can customize by standard css styles. Each element is responsive so you can add to it any other element to improve functionality of list.
                .pug#nestable2.dd
                  ol.pug.dd-list
                    li.pug.dd-item(data-id='1')
                      .pug.dd-handle
                        span.pug.label.h-bg-navy-blue
                          i.pug.fa.fa-users
                        span.pug  Cras ornare tristique.
                      ol.pug.dd-list
                        li.pug.dd-item(data-id='2')
                          .pug.dd-handle
                            span.pug.pull-right  12:00 pm 
                            span.pug.label.h-bg-navy-blue
                              i.pug.fa.fa-cog
                            span.pug  Vivamus vestibulum nulla nec ante.
                        li.pug.dd-item(data-id='3')
                          .pug.dd-handle
                            span.pug.pull-right  11:00 pm 
                            span.pug.label.h-bg-navy-blue
                              i.pug.fa.fa-bolt
                            span.pug  Nunc dignissim risus id metus.
                        li.pug.dd-item(data-id='4')
                          .pug.dd-handle
                            span.pug.pull-right  11:00 pm 
                            span.pug.label.h-bg-navy-blue
                              i.pug.fa.fa-laptop
                            span.pug  Vestibulum commodo
                    li.pug.dd-item(data-id='5')
                      .pug.dd-handle
                        span.pug.label.h-bg-navy-blue
                          i.pug.fa.fa-users
                        span.pug  Integer vitae libero.
                      ol.pug.dd-list
                        li.pug.dd-item(data-id='6')
                          .pug.dd-handle
                            span.pug.pull-right  15:00 pm 
                            span.pug.label.h-bg-navy-blue
                              i.pug.fa.fa-users
                            span.pug  Nam convallis pellentesque nisl.
                        li.pug.dd-item(data-id='7')
                          .pug.dd-handle
                            span.pug.pull-right  16:00 pm 
                            span.pug.label.h-bg-navy-blue
                              i.pug.fa.fa-bomb
                            span.pug  Vivamus molestie gravida turpis
                        li.pug.dd-item(data-id='8')
                          .pug.dd-handle
                            span.pug.pull-right  21:00 pm 
                            span.pug.label.h-bg-navy-blue
                              i.pug.fa.fa-child
                            span.pug  Ut aliquam sollicitudin leo.
                .pug.m-t-md
                  h5.pug Serialised Output
                textarea.pug#nestable2-output.form-control
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Nestable basic list
              .pug.panel-body
                p.pug.m-b-lg
                  strong.pug Nestable
                  span.pug  is an interactive hierarchical list. You can drag and drop to rearrange the order. It works well on touch-screens.
                .pug#nestable.dd
                  ol.pug.dd-list
                    li.pug.dd-item(data-id='1')
                      .pug.dd-handle 1 - Lorem ipsum
                    li.pug.dd-item(data-id='2')
                      .pug.dd-handle 2 - Dolor sit
                      ol.pug.dd-list
                        li.pug.dd-item(data-id='3')
                          .pug.dd-handle 3 - Adipiscing elit
                        li.pug.dd-item(data-id='4')
                          .pug.dd-handle 4 - Nonummy nibh
                    li.pug.dd-item(data-id='5')
                      .pug.dd-handle 5 - Consectetuer
                      ol.pug.dd-list
                        li.pug.dd-item(data-id='6')
                          .pug.dd-handle 6 - Aliquam erat
                        li.pug.dd-item(data-id='7')
                          .pug.dd-handle 7 - Veniam quis
                    li.pug.dd-item(data-id='8')
                      .pug.dd-handle 8 - Tation ullamcorper
                    li.pug.dd-item(data-id='9')
                      .pug.dd-handle 9 - Ea commodo
                .pug.m-t-md
                  h5.pug Serialised Output
                textarea.pug#nestable-output.form-control
