        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Timeline
            small.pug Present your events in timeline style.
      .pug.content
        .pug.row
          .pug.col-md-6
            .pug.hpanel
              .pug.v-timeline.vertical-container.animate-panel(data-child='vertical-timeline-block' data-delay='1')
                .pug.vertical-timeline-block
                  .pug.vertical-timeline-icon.navy-bg
                    i.pug.fa.fa-calendar
                  .pug.vertical-timeline-content
                    .pug.p-sm
                      span.pug.vertical-date.pull-right
                        span.pug Saturday 
                        br.pug
                        small.pug 12:17:43 PM
                      h2.pug The standard chunk of Lorem Ipsum
                      p.pug
                        span.pug Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                    .pug.panel-footer
                      span.pug It is a long established fact that
                .pug.vertical-timeline-block
                  .pug.vertical-timeline-icon.navy-bg
                    i.pug.fa.fa-calendar
                  .pug.vertical-timeline-content
                    .pug.p-sm
                      span.pug.vertical-date.pull-right
                        ...
                        br.pug
                        small.pug 12:17:43 PM
                      h2.pug There are many variations
                      p.pug
                        span.pug Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                    .pug.panel-footer
                      span.pug It is a long established fact that
                  ...
                  .pug.vertical-timeline-content
                    .pug.p-sm
                      span.pug.vertical-date.pull-right
                        ...
                        br.pug
                        small.pug 12:17:43 PM
                      h2.pug Contrary to popular belief
                      p.pug
                        span.pug Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                    .pug.panel-footer
                      span.pug It is a long established fact that
                  ...
                  .pug.vertical-timeline-content
                    .pug.p-sm
                      span.pug.vertical-date.pull-right
                        ...
                        br.pug
                        small.pug 12:17:43 PM
                      h2.pug The generated Lorem Ipsum
                      p.pug
                        span.pug Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                    .pug.panel-footer
                      span.pug It is a long established fact that
