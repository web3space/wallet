            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug App views
                li.pug.active
                  span.pug Social board 
            h2.pug.font-light.m-b-xs
              span.pug Social board
            small.pug Message board for social interactions.
      .pug.content
        .pug.row.social-board
          .pug.col-lg-4
            .pug.hpanel.hblue
              .pug.panel-body
            ...
            .pug.hpanel.hyellow
              .pug.panel-body
                .pug.media.social-profile.clearfix
                  ...
                  .pug.media-body
                    h5.pug Ivan Novak
                    small.pug.text-muted 26.11.2015
                .pug.social-content.m-t-md
            ...
            .pug.hpanel.hgreen
              .pug.panel-body
                .pug.media.social-profile.clearfix
                  ...
                  .pug.media-body
                    h5.pug John Smith
                    small.pug.text-muted 13.05.2015
                .pug.social-content.m-t-md
                  span.pug There are many variations of passages of Lorem Ipsum available, but the majority have By injected humour, or randomised words which don&apos;t look even slightly believable.
                  img.pug.img-responsive.m-t-md(src='images/p2.jpg' alt='')
              .pug.panel-footer
                .pug.social-talk
                  .pug.media.social-profile.clearfix
                    a.pug.pull-left
            ...
            .pug.hpanel.hgreen
              .pug.panel-body
                ...
                .pug.social-content.m-t-md
                  ...
                  br.pug
                  br.pug
                  span.pug                     It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.
              .pug.panel-footer
                .pug.social-talk
                  .pug.media.social-profile.clearfix
                    a.pug.pull-left
            ...
            .pug.hpanel.hblue
              .pug.panel-body
                .pug.media.social-profile.clearfix
                  ...
                  .pug.media-body
                    h5.pug Anna Smith
                    small.pug.text-muted 10.06.2015
                .pug.social-content.m-t-md
            ...
            .pug.hpanel.hyellow
              .pug.panel-body
                .pug.media.social-profile.clearfix
                  ...
                  .pug.media-body
                    h5.pug Mark Smith
                    small.pug.text-muted 02.02.2015
                .pug.social-content.m-t-md
                  span.pug It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
              .pug.panel-footer
                .pug.social-talk
              ...
              .pug.panel-body
                .pug.media.social-profile.clearfix
                  ...
                  .pug.media-body
                    ...
                    small.pug.text-muted 13.05.2015
                .pug.social-content.m-t-md
                  span.pug There are many variations of passages of Lorem Ipsum available, but the majority have By injected humour, or randomised words which don&apos;t look even slightly believable (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance
                  span.pug .
              .pug.panel-footer
                .pug.social-talk
                  .pug.media.social-profile.clearfix
