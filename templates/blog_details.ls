...
module.exports = ->
  ...
  body.pug.fixed-navbar.sidebar-scroll
    ...
    .pug#wrapper
      .pug.content.content-boxed
        .pug.row
          .pug.col-lg-12
            .pug.hpanel.blog-article-box
              .pug.panel-heading
                h4.pug Maecenas placerat facilisis
                small.pug There are many variations of passages of Lorem Ipsum available
                .pug.text-muted.small
                  span.pug Created by:
                  span.pug.font-bold Mike Smith
                  span.pug                             21.03.2015, 06:45 pm
              .pug.panel-body
                p.pug
                  span.pug Maecenas placerat facilisis interdum. Mauris eu dolor nisi. Suspendisse ullamcorper purus nec nibh maximus, ut sollicitudin enim venenatis.
                  span.pug Nullam interdum, odio sit amet dapibus mollis, ligula diam pretium sapien, eget suscipit felis ipsum sed lorem.
                  br.pug
                  br.pug
                  span.pug  Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Curabitur ultrices aliquam nisi, vel semper augue auctor eu. Pellentesque a
                  span.pug                             sollicitudin tellus. Aenean posuere pharetra ipsum, ornare pretium lorem convallis non. Vivamus ac sodales sem. Nunc congue dolor ut dui maximus, imperdiet sollicitudin
                  span.pug                             velit auctor. Integer tincidunt iaculis vehicula. Nunc faucibus orci non imperdiet ultricies. Nunc pellentesque dui nisi, vel convallis quam malesuada ornare. Nunc ac purus
                  span.pug                             velit. Cras aliquet porta sodales. Proin blandit ornare bibendum.
                br.pug
                blockquote.pug.pull-left(style='max-width: 250px')
                  p.pug Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                p.pug
                ...
                br.pug
                p.pug
                  span.pug Duis rutrum felis at lorem scelerisque, vel iaculis risus viverra. Integer sed gravida libero. Maecenas sit amet lacus et erat rhoncus sodales quis non nunc. Morbi in
                  span.pug mattis massa. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Phasellus bibendum posuere sapien eget vehicula. Nulla sit amet
                  span.pug laoreet ante, sed ornare mauris. In interdum ex et leo suscipit sagittis. Pellentesque ac eleifend quam. Nam eu lacinia lacus. Vestibulum lacinia nisl lectus, fringilla
                  span.pug molestie diam imperdiet dignissim.
                p.pug
                  span.pug In scelerisque urna ut neque imperdiet, sit amet pretium eros suscipit. Cras efficitur ante sit amet mi porta, varius volutpat nulla hendrerit. Pellentesque nec risus
                  span.pug malesuada, scelerisque libero at, lacinia magna. Aliquam tellus nunc, viverra in ipsum sed, tristique finibus nibh. Proin gravida lobortis erat, nec aliquam lorem eleifend
                  span.pug eget. Integer quis augue id felis ultricies finibus. Curabitur et ligula mauris. Suspendisse vel fringilla quam. Quisque quis metus rhoncus, eleifend leo in, sagittis
                  span.pug libero. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Fusce ullamcorper nisl risus, a scelerisque dui hendrerit nec.
                br.pug
                blockquote.pug.pull-right(style='max-width: 250px')
                  p.pug Fusce ac tellus eu nisl lobortis maximus
                p.pug
                ...
                br.pug
                p.pug
                  span.pug Sed porta libero metus, nec feugiat enim pharetra vel. Sed vel sagittis augue. Donec hendrerit nibh ac dolor lobortis, eu varius odio sollicitudin. Proin non condimentum
                  span.pug nulla, quis dictum leo. Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat leo condimentum lacus viverra sollicitudin. Donec dignissim ornare est, nec
                  span.pug scelerisque purus mollis eu. Phasellus dictum suscipit ligula. Donec malesuada gravida velit. Nulla egestas diam in ligula mollis, nec tincidunt diam porta. Proin eleifend
                  span.pug lacinia diam quis pretium. Sed lacinia varius nisi et euismod. Ut ac arcu vulputate, porta nibh non, ultricies erat. Nulla facilisi.
              .pug.panel-footer
                span.pug.pull-right
