        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Notes
            small.pug Build notebook functionality in your app
      .pug.content
        .pug.row
          .pug.col-md-3
            .pug.hpanel.panel-group
              .pug.panel-body
                .pug.text-center.text-muted.font-bold Search note or add new
              .pug.panel-section
                .pug.input-group
                  input.pug.form-control(type='text' placeholder='Search note...')
                  span.pug.input-group-btn
                    button.pug.btn.btn-default(type='button')
                      i.pug.glyphicon.glyphicon-plus.small
                button.pug.btn-sm.visible-xs.visible-sm.collapsed.btn-default.btn.btn-block.m-t-sm(type='button' data-toggle='collapse' data-target='#notes')
                  span.pug All notes 
                  i.pug.fa.fa-angle-down
              .pug#notes.collapse
                .pug.panel-body.note-link
                  a.pug(href='#note1' data-toggle='tab')
                    small.pug.pull-right.text-muted 26.10.2016
                    h5.pug Publishing packages
                    .pug.small
                      span.pug Many desktop publishing packages and web page editors now use Lorem
                .pug.panel-body.note-link
                  a.pug(href='#note2' data-toggle='tab')
                    small.pug.pull-right.text-muted 22.01.2016
                    h5.pug
                      span.pug Latin literature from
                    .pug.small
                      span.pug Lorem Ipsum, you need to be sure there
                .pug.panel-body.note-link
                  a.pug(href='#note3' data-toggle='tab')
                    small.pug.pull-right.text-muted 14.03.2016
                    h5.pug
                      span.pug The generated Lorem Ipsum
                    .pug.small
                      span.pug It has survived not only five centuries
                .pug.panel-body.note-link
                  a.pug(href='#note4' data-toggle='tab')
                    small.pug.pull-right.text-muted 07.10.2015
                    h5.pug
                      span.pug Neque porro quisquam
                    .pug.small
                      span.pug Finibus Bonorum et Malorum
                .pug.panel-body.note-link
                  a.pug(href='#note5' data-toggle='tab')
                    small.pug.pull-right.text-muted 12.04.2015
                    h5.pug
                      span.pug The first line of Lorem Ipsum
                    .pug.small
                      span.pug Lorem Ipsum which looks reasonable
          .pug.col-md-9
            .pug.hpanel
              .pug.panel-body
                .pug.text-center.hidden
                  span.pug We couldn&apos;t find any notes for you.
                .pug.tab-content
                  .pug#note1.tab-pane.active
                    .pug.pull-right.text-muted.m-l-lg
                      span.pug 26.10.2016
                    h3.pug Publishing packages
                    hr.pug
                    .pug.note-content
                      textarea.pug.form-control
                        span.pug It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &apos;Content here, content here&apos;, making it look like readable English.
                        span.pug Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &apos;lorem ipsum&apos; will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
                        span.pug Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
                    .pug.btn-group
                      button.pug.btn.btn-sm.btn-default
                  ...
                  .pug#note3.tab-pane
                    .pug.pull-right.text-muted.m-l-lg
                      span.pug 14.03.2016
                    h3.pug The generated Lorem Ipsum 
                    hr.pug
                    .pug.note-content
                      textarea.pug.form-control
                        span.pug It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &apos;Content here, content here&apos;, making it look like readable English.
                  ...
                  .pug#note5.tab-pane
                    .pug.pull-right.text-muted.m-l-lg
                      span.pug 12.04.2015
                    h3.pug The first line of Lorem Ipsum 
                    hr.pug
                    .pug.note-content
                      textarea.pug.form-control
                        span.pug Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
