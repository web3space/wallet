            ...
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                     FooTable with row toggler, sorting, filter and pagination
              .pug.panel-body
                input.pug#filter.form-control.input-sm.m-b-md(type='text' placeholder='Search in table')
                table.pug#example1.footable.table.table-stripped.toggle-arrow-tiny(data-page-size='8' data-filter='#filter')
                  thead.pug
                    tr.pug
                      th.pug(data-toggle='true') Project
                      th.pug Name
                      th.pug Phone
                      th.pug Company
                      th.pug(data-hide='all') Completed
                      th.pug(data-hide='all') Task
                      th.pug(data-hide='all') Date
                  tbody.pug
                    tr.pug
            ...
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                     Basic example with row toggler option
              .pug.panel-body
                table.pug#example2.footable.table.table-bordered.table-hover
                  thead.pug
                    tr.pug
                      th.pug Name
                      th.pug Position
                      th.pug(data-hide='phone') Office
                      th.pug(data-hide='phone,tablet') Age
                      th.pug(data-hide='phone,tablet') Start date
                      th.pug(data-hide='phone,tablet') Salary
                  tbody.pug
                    tr.pug
                      td.pug Tiger Nixon
