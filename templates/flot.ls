        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Flot chart
            small.pug
              span.pug Flot is a pure JavaScript plotting library for jQuery, with a focus on simple usage, attractive looks and interactive features.
      .pug.content
        .pug.row
          .pug.col-lg-8
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Line type chart with tension
              .pug.panel-body
                .pug.flot-chart
            ...
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Pie type chart
              .pug.panel-body
                .pug.flot-pie-chart
                  .pug#flot-pie-chart.flot-chart-pie-content
          .pug.col-lg-8
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Area type chart
              .pug.panel-body
                .pug.flot-chart
                  .pug#flot-area-chart.flot-chart-content
        .pug.row
          .pug.col-lg-12
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Line with points
              .pug.panel-body
                .pug.flot-chart
                  .pug#flot-sin-chart.flot-chart-content
