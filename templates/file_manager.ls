            ...
            .pug#hbreadcrumb.pull-right.m-t-lg
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug App views
                li.pug.active
                  span.pug File manager
            h2.pug.font-light.m-b-xs
              span.pug File manager
            small.pug Show you files in a nica manager design.
      .pug.content
        .pug.row
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.dropdown
                  a.pug.dropdown-toggle.btn.btn-primary.btn-block(href='#' data-toggle='dropdown')
                    span.pug NEW
                  ul.pug.dropdown-menu.filedropdown.m-l
                    li.pug
                      a.pug(href='#')
                ...
                ul.pug.h-list.m-t
                  ...
                  li.pug
                    a.pug(href='#')
                      i.pug.fa.fa-user.text-info
                      span.pug  Shared with me
                  li.pug
                    a.pug(href='#')
                      i.pug.fa.fa-clock-o.text-success
                      span.pug  Recent
                  li.pug
                    a.pug(href='#')
                  ...
                  li.pug
                    a.pug(href='#')
                      i.pug.fa.fa-trash.text-danger
                      span.pug  Trash
            .pug.hpanel
              .pug.panel-body
                h3.pug 6 GB used
                p.pug It is 65% of all your storage
                .pug.progress.full.m-t-xs
                  .pug.progress-bar.progress-bar-info(style='width: 65%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='65' role='progressbar')
                    span.pug 65%
                small.pug
                  span.pug Lorem ipsum dolor sit amet, consectetur adipiscing elit vestibulum adipiscing elit.
          .pug.col-md-9
            .pug.row
              .pug.col-md-3
                .pug.hpanel
              ...
              .pug.col-md-3
                .pug.hpanel
                  .pug.panel-body.file-body
                    i.pug.fa.fa-file-powerpoint-o.text-danger
                  .pug.panel-footer
                    a.pug(href='#') Presentation_2016.doc
                .pug.hpanel
                  .pug.panel-body.file-body
                    i.pug.fa.fa-file-powerpoint-o.text-danger
                  .pug.panel-footer
