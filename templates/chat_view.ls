        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Chat view
            small.pug Create a chat rooom in your app
      .pug.content
        .pug.row
          .pug.col-md-12
            .pug.hpanel
                ...
                .pug.row
                  ...
                  .pug.col-md-3
                    .pug.chat-users
                      .pug.users-list
                        .pug.chat-user
                          span.pug.pull-right.label.label-success Online
                          img.pug.chat-avatar(src='images/a3.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Janet Smith
                        .pug.chat-user
                          img.pug.chat-avatar(src='images/a1.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Monica Smith
                        .pug.chat-user
                          span.pug.pull-right.label.label-success Online
                          img.pug.chat-avatar(src='images/a2.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Michael Smith
                        .pug.chat-user
                          img.pug.chat-avatar(src='images/a4.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Karl Jordan
                        .pug.chat-user
                          img.pug.chat-avatar(src='images/a5.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Alice Smith
                        .pug.chat-user
                          img.pug.chat-avatar(src='images/a6.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Monica Cale
                        .pug.chat-user
                          img.pug.chat-avatar(src='images/a2.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Mark Jordan
                        .pug.chat-user
                          span.pug.pull-right.label Online
                          img.pug.chat-avatar(src='images/a3.jpg' alt='')
                          .pug.chat-user-name
                            a.pug(href='#') Janet Smith
                        .pug.chat-user
                        ...
                        .pug.chat-user
                          ...
                          .pug.chat-user-name
                            a.pug(href='#') Mark Jordan
              .pug.panel-footer.borders
                .pug.input-group
                  input.pug.form-control(type='text' placeholder='Type your message here...')
                  span.pug.input-group-btn
                    button.pug.btn.btn-success
                      span.pug Send
