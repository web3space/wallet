            ...
            .pug#hbreadcrumb.pull-right
              ol.pug.hbreadcrumb.breadcrumb
                ...
                li.pug
                  span.pug Forms
                li.pug.active
                  span.pug Text editor 
            h2.pug.font-light.m-b-xs
              span.pug Text editor
            small.pug Lorem Ipsum has been the dustrys
      .pug.content
        div.pug
          .pug.row
            .pug.col-lg-12
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Summernote standard editor
                .pug.panel-body
                  .pug.summernote
                    h3.pug Hello Jonathan! 
                    p.pug
              ...
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Summernote with custom toolbar
                .pug.panel-body
                  .pug.summernote1
                    h4.pug It is a long established fact
                    p.pug
              ...
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    ...
                    a.pug.closebox
                      i.pug.fa.fa-times
                  span.pug                     Summernote airMode
                .pug.panel-body.airmode
                  .pug.summernote2
                    h4.pug It is a long established fact
                    p.pug
                      span.pug Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like)
