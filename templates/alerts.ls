        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Alerts
            small.pug Notification and custom alerts
      .pug.content
        .pug.row
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                 Sweet alert
              .pug.panel-body
                p.pug
                  span.pug Sweet Alert is a beautiful replacement for standard Javascript&apos;s &quot;Alert&quot;.
                table.pug.table.table-hover.table-striped
                  thead.pug
                    tr.pug
                      th.pug
                        span.pug Examples
                  ...
                  tbody.pug
                    tr.pug
                      td.pug
                        span.pug A basic message
                      td.pug
                        button.pug.btn.btn-primary.btn-sm.demo1 Run example
                    tr.pug
                      td.pug
                        span.pug A success message!
                      td.pug
                        button.pug.btn.btn-success.btn-sm.demo2 Run example
                    tr.pug
                      td.pug
                        span.pug A warning message, with a function attached to the &quot;Confirm&quot;-button
                      td.pug
                        button.pug.btn.btn-warning.btn-sm.demo3 Run example
                    tr.pug
                      td.pug
                        span.pug ... and by passing a parameter, you can execute something else for &quot;Cancel&quot;.
                      td.pug
                        button.pug.btn.btn-danger.btn-sm.demo4 Run example
                .pug.m-t-md
                  p.pug
                    span.pug You can easy add sweet alert in your controller by adding code like this:
                  pre.pug nswal({ title: "Good job!", text: "You clicked the button!", type: "success"});
          .pug.col-lg-6
            .pug.hpanel
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                Toastr notification
              .pug.panel-body
                p.pug
                  span.pug Minimalistic and extensible notification service for Homer theme.
                .pug.text-center.float-e-margins
                  .pug.font-bold.m Example with Homer template
                  button.pug.homerDemo1.btn.btn-info.btn-sm Run example
                  button.pug.homerDemo2.btn.btn-success.btn-sm Run example
                  button.pug.homerDemo3.btn.btn-warning.btn-sm Run example
                  button.pug.homerDemo4.btn.btn-danger.btn-sm Run example
                .pug.m-t-md
                  p.pug
                    span.pug You can easy add any notification in your scripts by adding code like this:
