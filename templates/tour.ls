        ...
        .pug.hpanel.tour-1
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Tour
            small.pug The easiest way to show people how to use your website.
      .pug.content
        .pug.row
          .pug.col-lg-12
            .pug.hpanel.tour-2
              .pug.panel-heading
                .pug.panel-tools
                  ...
                  a.pug.closebox
                    i.pug.fa.fa-times
                span.pug                         Tour - how it works.
              .pug.panel-body
                .pug.row
                  .pug.col-lg-4.tour-3
                    p.pug
                      strong.pug Start
                      span.pug  tour example!
                    button.pug.btn.btn-success.m-b-lg.run-tour Start Tour!
                    h5.pug
                      span.pug Example text for tour purpose
                    p.pug
                      span.pug It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that
                      span.pug it has a more-or-less normal distribution of letters, as opposed to using &apos;Content here, content here&apos;, making it look like readable English.
                    .pug.flot-chart(style='height: 50px')
                  ...
                  .pug.col-lg-8.tour-4
                    h5.pug
                      span.pug How to use it
                    p.pug
                      span.pug Tour is very easy to use. All you have to do is to define main tour object
                      code.pug var tour = new Tour
                      span.pug . You can add
                      code.pug backdrop: true,
                      span.pug  to add a gray background.
                      span.pug                                     Next you need to define a tour step with array:
                    strong.pug  Example:
                    pre.pug.
                      \n
                      var.pug tour = new Tour({
                        steps.pug: [
                        {
                          element.pug: ".my-element",
                          title.pug: "Title of my step",
                          content.pug: "Content of my step"
                        },
                        {
                          element.pug: ".my-other-element",
                          title.pug: "Title of my step",
                          content.pug: "Content of my step"
                        }
                      ]});
                ...
                .pug.row
                  .pug.col-lg-12
                    h5.pug
                      span.pug Configuration
                    p.pug
                      strong.pug See full documentation of official tour plugin:
                      a.pug(href='http://bootstraptour.com/' target='_blank') http://bootstraptour.com/
                      span.pug .
