...
module.exports = ->
  ...
  body.pug.fixed-navbar.sidebar-scroll
        ...
        .pug.hpanel
          .pug.panel-body
            ...
            h2.pug.font-light.m-b-xs
              span.pug Gallery
            small.pug Touch-enabled, responsive and customizable image &amp; video gallery.
      .pug.content
        .pug.row
          .pug.col-lg-12
            .pug.hpanel
              .pug.panel-body
                .pug.lightBoxGallery
                  p.pug
                    strong.pug Blueimp Gallery
                    span.pug   is a touch-enabled, responsive and customizable image &amp; video gallery, carousel and
                    span.pug                                 lightbox, optimized for both mobile and desktop web browsers.
                    span.pug                                 It features swipe, mouse and keyboard navigation, transition effects, slideshow
                    span.pug                                 functionality, fullscreen support and on-demand content loading and can be extended to
                    span.pug                                 display additional content types.
                  a.pug(href='images/gallery/1.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/1s.jpg')
                  a.pug(href='images/gallery/2.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/2s.jpg')
                  a.pug(href='images/gallery/3.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/3s.jpg')
                  a.pug(href='images/gallery/4.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/4s.jpg')
                  a.pug(href='images/gallery/5.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/5s.jpg')
                  a.pug(href='images/gallery/6.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/6s.jpg')
                  a.pug(href='images/gallery/7.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/7s.jpg')
                  a.pug(href='images/gallery/8.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/8s.jpg')
                  a.pug(href='images/gallery/9.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/9s.jpg')
                  a.pug(href='images/gallery/10.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/10s.jpg')
                  a.pug(href='images/gallery/1.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/1s.jpg')
                  a.pug(href='images/gallery/2.jpg' title='Image from Unsplash' data-gallery='')
                    img.pug(src='images/gallery/2s.jpg')
    ...
    .pug#blueimp-gallery.blueimp-gallery
      .pug.slides
      h3.pug.title
      a.pug.prev &lsaquo;
      a.pug.next &rsaquo;
