        ...
        .pug.row
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.text-center
                  h2.pug.m-b-xs Box title
                  p.pug.font-bold.text-success Lorem ipsum
                  .pug.m
                    i.pug.pe-7s-science.fa-5x
                  p.pug.small
                    span.pug Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                  button.pug.btn.btn-success.btn-sm Action button
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.text-center
                  h2.pug.m-b-xs Box title
                  p.pug.font-bold.text-info Lorem ipsum
                  .pug.m
                    i.pug.pe-7s-global.fa-5x
                  p.pug.small
                    span.pug Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                  button.pug.btn.btn-info.btn-sm Action button
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.text-center
                  h2.pug.m-b-xs Box title
                  p.pug.font-bold.text-warning Lorem ipsum
                  .pug.m
                    i.pug.pe-7s-display1.fa-5x
                  p.pug.small
                    span.pug Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                  button.pug.btn.btn-warning.btn-sm Action button
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.text-center
                  h2.pug.m-b-xs Box title
                  p.pug.font-bold.text-danger Lorem ipsum
                  .pug.m
                    i.pug.pe-7s-airplay.fa-5x
                  p.pug.small
                    span.pug Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                  button.pug.btn.btn-danger.btn-sm Action button
        .pug.row
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
            ...
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title.pull-left
                  h4.pug Acite Views
                .pug.stats-icon.pull-right
                  i.pug.pe-7s-shuffle.fa-4x
                .pug.m-t-xl
                  h1.pug.text-info 462
                  small.pug
                    span.pug Lorem Ipsum is simply dummy text of the printing and 
                    strong.pug typesetting industry
                    span.pug . Lorem Ipsum has been.
            ...
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title.pull-left
                  h4.pug Income
                .pug.stats-icon.pull-right
                  i.pug.pe-7s-ticket.fa-4x
                .pug.m-t-xl
                  h1.pug.text-warning $200,00
                  small.pug
                    span.pug Lorem Ipsum is simply dummy text of the printing and 
                    strong.pug typesetting industry
                    span.pug . Lorem Ipsum has been.
            ...
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title.pull-left
                  h4.pug Messages
                .pug.stats-icon.pull-right
                  i.pug.pe-7s-attention.fa-4x
                .pug.m-t-xl
                  h1.pug.text-danger 680
                  small.pug
                    span.pug Lorem Ipsum is simply dummy text of the printing and 
                    strong.pug typesetting industry
                    span.pug . Lorem Ipsum has been.
          ...
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title.pull-left
                  h4.pug Chart box
                .pug.flot-chart(style='height: 150px')
                  .pug#flot-line-chart.flot-chart-content(style='height: 150px')
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title.pull-left
                  h4.pug Chart box
                .pug.flot-chart(style='height: 150px')
                  .pug#flot-bar-chart.flot-chart-content(style='height: 150px')
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title.pull-left
                  h4.pug Chart box
                .pug.flot-chart.m-t-lg(style='height: 120px')
                  .pug#flot-pie-chart.flot-chart-content(style='height: 120px')
          .pug.col-md-3
            .pug.hpanel
              .pug.panel-body
                .pug.stats-title
                ...
                .pug.m-t-lg
                  .pug.progress.m-t-xs.full.progress-small
                    .pug.progress-bar.progress-bar-danger(style='width: 25%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='25' role='progressbar')
                      span.pug.sr-only 35% Complete (success)
                  .pug.progress.m-t-xs.full.progress-small
                    .pug.progress-bar.progress-bar-danger(style='width: 35%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='35' role='progressbar')
                      span.pug.sr-only 35% Complete (success)
                  .pug.progress.m-t-xs.full.progress-small
                    .pug.progress-bar.progress-bar-danger(style='width: 55%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='55' role='progressbar')
                      span.pug.sr-only 35% Complete (success)
                  .pug.progress.m-t-xs.full.progress-small
                    .pug.progress-bar.progress-bar-danger(style='width: 75%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='75' role='progressbar')
                      span.pug.sr-only 35% Complete (success)
                  .pug.progress.m-t-xs.full.progress-small
                    .pug.progress-bar.progress-bar-danger(style='width: 95%' aria-valuemax='100' aria-valuemin='0' aria-valuenow='95' role='progressbar')
                      span.pug.sr-only 35% Complete (success)
        .pug.row
          .pug.col-md-3
            .pug.hpanel.hbggreen
                ...
                .pug.table-responsive
                  table.pug.table.table-striped
                    ...
                    tbody.pug
                      tr.pug
                        td.pug
                          span.pug.text-success.font-bold Lorem ipsum
                        td.pug Jul 14, 2013
                      tr.pug
                        td.pug
                          span.pug.text-success.font-bold Lorem ipsum
                ...
                .pug.table-responsive
                  table.pug.table.table-striped
                    ...
                    tbody.pug
                      tr.pug
                        td.pug
                          span.pug.text-info.font-bold Lorem ipsum
                        td.pug Jul 14, 2013
                      tr.pug
                        td.pug
                          span.pug.text-info.font-bold Lorem ipsum
                ...
                .pug.table-responsive
                  table.pug.table.table-striped
                    ...
                    tbody.pug
                      tr.pug
                        td.pug
                          span.pug.text-warning.font-bold Lorem ipsum
                        td.pug Jul 14, 2013
                      tr.pug
                        td.pug
                          span.pug.text-warning.font-bold Lorem ipsum
                ...
                .pug.table-responsive
                  table.pug.table.table-striped
                    ...
                    tbody.pug
                      tr.pug
                        td.pug
                          span.pug.text-danger.font-bold Lorem ipsum
                        td.pug Jul 14, 2013
                      tr.pug
                        td.pug
                          span.pug.text-danger.font-bold Lorem ipsum
