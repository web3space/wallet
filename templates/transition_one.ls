  ...
  body.pug.fixed-navbar.sidebar-scroll
    ...
    .pug#wrapper
      .pug.p-lg
        .pug.content
          .pug.row
            .pug.col-lg-4.animate-panel(data-child='hpanel' data-effect='fadeInLeft')
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    a.pug.showhide
              ...
              .pug.hpanel
                ...
                .pug.panel-body
                  .pug.h-100
            .pug.col-lg-4.animate-panel(data-child='hpanel')
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    a.pug.showhide
              ...
              .pug.hpanel
                ...
                .pug.panel-body
                  .pug.h-100
            .pug.col-lg-4.animate-panel(data-child='hpanel' data-effect='fadeInRight')
              .pug.hpanel
                .pug.panel-heading
                  .pug.panel-tools
                    a.pug.showhide
