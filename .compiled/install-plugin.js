...
(function(){
  var localStorage, ref$, any, map, install, replace, get, jsonParse, requiredFields, notIn, verifyPlugin, getRegistry, getPlugin, getInstallList, saveRegistry, addToRegistry, removeFromRegistry, buildName, installPlugin, uninstallPlugin, askUser, buildInstall, buildUninstall, buildInstallByName, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.buildInstallByName = buildInstallByName = function(cweb3, store){
    return function(name, cb){
      return get("https://raw.githubusercontent.com/web3space/plugin-registry/master/plugins/" + name + ".json", function(err, resp){
        if (err != null) {
          return cb(err);
        }
