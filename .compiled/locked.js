...
(function(){
  var react, map, ref$, set, check, exists, navigate, goto, wrongPin, checkPin, goBack, goForward, setVal, setupKeydown, setupVal, input, wrongTrials, setupButton, locked, focus;
  react = require('react');
