...
(function(){
  var react, map, ref$, set, check, exists, navigate, goto, wrongPin, checkPin, goBack, goForward, setVal, setupKeydown, setupVal, input, wrongTrials, setupButton, loading, locked, init;
  react = require('react');
  ...
  locked = function(arg$){
    var store, title, footer, children;
    store = arg$.store;
    ...
    return react.createElement('div', {
      className: 'locked locked1567056849'
    }, children = [
