...
(function(){
  var stringify, ref$, filter, map, foldl, each, plus, minus, times, div, get, Web3, Tx, BN, jsonParse, getFullpairByIndex, abi, getContractInstance, calcFee, getKeys, toHex, transformTx, getTransactions, getWeb3, getDec, createTransaction, checkDecodedData, pushTx, getBalance, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    var network, sender, recepient, amount, amountFee, web3, dec, privateKey;
    ...
    return web3.eth.getTransactionCount(sender.address, 'pending', function(err, nonce){
      ...
      return web3.eth.getGasPrice(function(err, gasPrice){
        var gasEstimate, data, tx, rawtx;
        gasEstimate = div(toWei(amountFee), gasPrice);
        data = (function(){
          switch (false) {
          case contract.methods == null:
            return contract.methods.transfer(recepient, value).encodeABI();
          default:
            return contract.methods.transfer.getData(recepient, value);
          }
        }());
        tx = new Tx({
          nonce: toHex(nonce),
