...
(function(){
  var ref$, filter, reverse, head, foldl, getInstallList, common, verifyFields, getMethods, support, replace, put, getTopupAddress, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ref$ = require('prelude-ls'), filter = ref$.filter, reverse = ref$.reverse, head = ref$.head, foldl = ref$.foldl;
  getInstallList = require('./install-plugin.ls').getInstallList;
  common = [require('../web3t/plugins/trycrypto-topup.ls')];
  ...
  out$.getTopupAddress = getTopupAddress = function(arg$){
