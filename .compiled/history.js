...
(function(){
  var react, whitebox, transactions, ref$, sortBy, reverse, filter, map, find, moment, coins, navigate, toJS;
  react = require('react');
  ...
  module.exports = function(arg$){
    var store, cutTx, ago, date, filt, filterTxs, appliedTransactions, arrow, goBack, extended, cutAmount, amountBeautify, isActive, switchFilter, switchTypeIn, switchTypeOut, children, coin, token, tx, amount, fee, time, url, type, this$ = this;
    store = arg$.store;
    cutTx = function(tx){
      var t, r;
      if (tx == null) {
