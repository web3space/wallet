...
(function(){
  var whitebox, transactions, ref$, sortBy, reverse, filter, map, find, moment, getCoins, navigate, toJS, react, removeTx, web3;
  ...
  module.exports = function(arg$){
    var store, cutTx, ago, date, filt, filterTxs, appliedTransactions, arrow, goBack, extended, cutAmount, amountBeautify, isActive, switchFilter, switchTypeIn, switchTypeOut, coins, deletePendingTx, children, coin, tran, token, tx, amount, fee, time, url, type, pending;
    store = arg$.store;
    cutTx = function(tx){
      var t, r;
      if (tx == null) {
    ...
    deletePendingTx = function(tx){
      return function(event){
        if (!confirm("Would you like to remove pending transaction? Your balance will be increased till confirmed transaction")) {
          return;
        }
    ...
    return react.createElement('div', {
      className: 'normalheader history history989660169'
    }, children = [
      react.createElement('div', {
        ...
        react.createElement('div', {
          ...
          for (i$ = 0, len$ = (ref$ = appliedTransactions).length; i$ < len$; ++i$) {
            tran = ref$[i$];
            token = tran.token, tx = tran.tx, amount = tran.amount, fee = tran.fee, time = tran.time, url = tran.url, type = tran.type, pending = tran.pending;
            coin = find(fn$)(
            coins);
            results$.push(react.createElement('div', {
              ...
              react.createElement('div', {
                ...
                react.createElement('a', {
                  ...
                  react.createElement('span', {}, ' ' + ago(time)), pending === true ? react.createElement('span', {}, children = [
                    react.createElement('span', {
                      className: 'bold'
