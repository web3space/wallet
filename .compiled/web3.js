...
(function(){
  var getCoins, ref$, objToPairs, map, pairsToObj, each, find, guid, waitFormResult, changeAmount, div, plus, web3, protect, navigate, useNetwork, getBalance, buildInstall, refreshAccount, state, titles, showCases, buildGetBalance, buildSendTransaction, buildNetworkSpecific, buildApi, buildUse, getApis, clearApi, refreshApis, slice$ = [].slice, toString$ = {}.toString;
