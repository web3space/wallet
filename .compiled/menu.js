...
(function(){
  var react, filter, whitebox, naming, seed, useNetwork, web3, check, navigate, round5, getContainer, generateWallet, state;
  react = require('react');
        ...
        react.createElement('div', {
          ...
          react.createElement('div', {
            ...
            react.createElement('div', {
              ...
              ? react.createElement('div', {}, ' ' + round5(current.balanceUsd))
              : react.createElement('div', {}, ' ...'))
          ])
        ])), react.createElement('div', {
          onClick: activateS3,
