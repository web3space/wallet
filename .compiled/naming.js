...
(function(){
  var react, ethnamed, ref$, map, join, filter, head, icon, installRecord, state;
  react = require('react');
  ...
  module.exports = function(arg$){
    ...
    buyNickname = function(cb){
      var name, owner, amountEthers, record, this$ = this;
    ...
    setMask = function(){
      var n, ref$;
      n = (ref$ = store.current.nickname) != null ? ref$ : "";
      return store.current.nicknamefull = (function(){
        switch (false) {
        case n.length !== 0:
    ...
    return react.createElement('div', {
      className: 'box-container naming naming1879046077'
