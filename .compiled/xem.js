...
(function(){
  var nem, get, jsonParse, ref$, filter, map, head, minus, div, deadline, calcFee, getKeys, transformTransfer, getTransactions, createTransaction, pushTx, getBalance, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    var network, sender, recepient, amount, amountFee, data, messageType, common, transferTransaction, transactionEntity, kp, serialized, signature, result, rawtx;
    network = arg$.network, sender = arg$.sender, recepient = arg$.recepient, amount = arg$.amount, amountFee = arg$.amountFee, data = arg$.data, messageType = arg$.messageType;
    if (network == null || sender == null || recepient == null || amountFee == null) {
      return cb("Params are required");
    }
    common = nem.model.objects.create('common')("", sender.privateKey);
