...
(function(){
  var moment, ref$, map, foldl, any, each, find, sum, filter, head, get, post, plus, minus, div, times, BitcoinLib, jsonParse, getFullpairByIndex, deadline, getMasternodeList, findMax, getOneOfMasternode, calcDynamicFee, calcFeePrivate, calcFeeInstantx, calcFee, getKeys, extend, getDec, addValue, getOutputs, parseRateString, extractVal, parseResult, getDepositAddressInfo, getDepositAddressFromList, getDepositAddress, addOutputsPrivate, addOutputs, createTransaction, pushTx, getBalance, incomingVout, outcomingVouts, transformIn, transformOut, transformTx, getApiUrl, checkTxStatus, getTransactions, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this, slice$ = [].slice;
  moment = require('moment');
  ref$ = require('prelude-ls'), map = ref$.map, foldl = ref$.foldl, any = ref$.any, each = ref$.each, find = ref$.find, sum = ref$.sum, filter = ref$.filter, head = ref$.head;
  ...
  calcDynamicFee = function(arg$, cb){
    ...
    return get(getApiUrl(network) + "/utils/estimatefee?nbBlocks=6").timeout({
      ...
      var values, exists, ref$, calcedFee;
      if (err != null) {
        return cb(err);
      }
      values = Object.values(data.body);
      exists = (ref$ = values[0]) != null
        ? ref$
        : -1;
      calcedFee = (function(){
        switch (false) {
  ...
  calcFeePrivate = function(arg$, cb){
    var network, tx, txType, account, feeType, ref$, o;
    network = arg$.network, tx = arg$.tx, txType = arg$.txType, account = arg$.account, feeType = arg$.feeType;
  ...
  out$.calcFee = calcFee = function(config, cb){
    ...
    return calcDynamicFee(config, cb);
  };
  ...
  out$.createTransaction = createTransaction = function(arg$, cb){
    var network, account, recipient, amount, amountFee, feeType, txType;
  ...
  transformIn = function(arg$, t){
    var net, address, network, tx, time, fee, ref$, vout, unspend, amount, to, url;
  ...
  transformOut = function(arg$, t){
    var net, address, network, tx, time, fee, ref$, vout, outcoming, amount, to, url;
    net = arg$.net, address = arg$.address;
    network = net.token;
    tx = t.txid;
    time = t.time;
