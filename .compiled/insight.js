...
(function(){
  ...
  calcFeePerByte = function(config, cb){
    ...
    return getOutputs({
      ...
      var feeType, amountFee, recipient;
      if (err != null) {
        return cb(err);
      }
      feeType = 'cheap';
      amountFee = network.txFee;
      ...
      return createTransaction((import$({
        ...
        calcFee = bytes * +o.feePerByte;
        finalPrice = calcFee > +o.cheap
          ? calcFee
          : o.cheap;
  ...
  out$.createTransaction = createTransaction = function(config, cb){
    ...
    return getOutputs({
      ...
      return getEnough(outputs, amount, 0, function(err, outputs){
  ...
  out$.pushTx = pushTx = curry$(function(arg$, cb){
    ...
    return post(getApiUrl(network) + "/tx/" + sendType, {
      ...
      var ref$;
      if (err != null) {
        return cb(err + ": " + (res != null ? res.body : void 8));
      }
