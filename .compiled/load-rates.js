...
(function(){
  var get, ref$, map, groupBy, objToPairs, pairsToObj, flatten, filter, task, run, parseRateString, parseUsdInfo, makeLoader, invalidUrl, createTask, extractVal, modifyItem, setVal, setVals, getData, loadRates, toString$ = {}.toString, slice$ = [].slice;
  ...
  modifyItem = curry$(function(data, item){
    ...
    val = (function(){
      switch (false) {
      case (data != null ? data.body : void 8) == null:
        return extractVal(data.body, item.extract.split('.').splice(1));
      default:
        return "";
      }
    }());
